...
import gg.projecteden.crates.util.*;
...
public class GemCrafterAnimation extends CrateAnimation {
	...
	public GemCrafterAnimation(Location center, BiFunction<Location, Consumer<Item>, Item> spawnItemHook) {
